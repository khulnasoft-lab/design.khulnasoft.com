        ...
        <template v-if="contentTree">
          ...
          >
            <summary class="nav-sidebar__section-summary">Brand</summary>
              ...
              class="nav-sidebar__section"
              >
              <summary class="nav-sidebar__section-summary">Brand personality</summary>
            </details>
            ...
            <details 
              ...
              class="nav-sidebar__section"
            >
              <summary class="nav-sidebar__section-summary">Tone of voice</summary>
            </details>
            ...
            <details 
              ...
              class="nav-sidebar__section"
            >
              <summary class="nav-sidebar__section-summary">Brand guidelines</summary>
              <nuxt-link 
