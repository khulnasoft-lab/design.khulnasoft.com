...
const GITLAB_UI_URL = process.env.GITLAB_UI_URL || 'https://gitlab-org.gitlab.io/gitlab-ui';
...
const cspPolicies = [
  ...
  `child-src https://www.figma.com https://gitlab.com https://projects.gitlab.io ${
