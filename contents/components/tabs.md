...
- Tabs will wrap by default when they overflow the container. When adapting to the browser size or in cases when a large umber of items are needed, consider using scrollable tabs.
