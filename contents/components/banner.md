...
- An optional [illustration](/product-foundations/illustration) to support the message uses the [small](/product-foundations/illustration#grid-and-size) illustration size and [round](/product-foundations/illustration#shape) shape.
