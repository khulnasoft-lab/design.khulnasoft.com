...
| **Do** | **Don’t** |
| :---: | :---: |
| <figure class="figure" role="figure" aria-label="Table row content vertially aligned to top"><img class="figure-img" src="/img/table-valign-top-do.svg" alt="A table row example with multiple lines that wrap with a green line highlighting the top alignment" role="img" /><figcaption class="figure-caption">Top align when mulitple lines present</figcaption></figure> | <figure class="figure" role="figure" aria-label="Icon not horizontally aligned to the pixel grid"><img class="figure-img" src="/img/table-valign-top-dont.svg" alt="An incorrect table row example with a single line with a red line highlighting the middle alignment" role="img" /><figcaption class="figure-caption">Do not middle align multiple lines</figcaption></figure> |

| **Do** | **Don’t** |
| :---: | :---: |
| <figure class="figure" role="figure" aria-label="Table row content vertially aligned to middle"><img class="figure-img" src="/img/table-valign-middle-do.svg" alt="A table row example with multiple lines that wrap with a green line highlighting the middle alignment" role="img" /><figcaption class="figure-caption">Middle align when elements in cells vary in height</figcaption></figure> | <figure class="figure" role="figure" aria-label="Table row content vertially aligned to middle"><img class="figure-img" src="/img/table-valign-middle-dont.svg" alt="An incorrect table row example with a single line with a red line highlighting the middle alignment" role="img" /><figcaption class="figure-caption">Do not top align a single row of elements</figcaption></figure> |
