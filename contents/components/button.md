...
Affirmative actions have been positioned to the left and dismissive actions have been positioned to the right. An affirmative action is something that takes the users further in their journey (for example, Save or Delete), while a dismissive action takes a user back (for example, Cancel).
