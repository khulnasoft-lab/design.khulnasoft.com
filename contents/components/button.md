...
- **Block**: Expand the width of a button to fill the parent container which can help provide balance in mobile ([xs breakpoint](https://design.gitlab.com/product-foundations/layout#grid)) layouts.
