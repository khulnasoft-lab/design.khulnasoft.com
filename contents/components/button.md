...
| <figure class="figure" role="figure" aria-label="Keep destructive buttons separate"><img class="figure-img" src="/img/buttons-with-danger-do-separate.svg" alt="Buttons in a group" role="img" /><figcaption class="figure-caption">Keep destructive buttons separate</figcaption></figure> | <figure class="figure" role="figure" aria-label="Group destructive buttons with confirmation buttons"><img class="figure-img" src="/img/buttons-with-danger-dont-group.svg" alt="Buttons that should be in a group are separated" role="img" /><figcaption class="figure-caption">Group destructive buttons with confirmation buttons</figcaption></figure> |
