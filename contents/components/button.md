...
Dropdown buttons may be split when additional related actions are available. The text button should be the primary action and the attached dropdown should contain those related actions and should take action immediately after click.
