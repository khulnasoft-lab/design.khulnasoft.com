...
| -------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Plain dropdowns            | These dropdowns usually present a list of actions. They can be thought of as a collection of buttons. | After user click on one of the buttons in the dropdown, page redirect or reload. If only partially page reload, dropdown act as a filter, either single selection or multi-selection should be a more appropriate choice.                              |
| Single-selection dropdowns | These dropdowns are used as a collection of single selection inputs.                                  | The radio button indicates that this is a single selection.  After the user select one, dropdown closes, request sends with a content update if needed.                                                                                                |
| Multi-selection dropdowns  | These dropdowns are used as a collection of multi-selection inputs.                                   | The checknox indicates that this is a multi-selection. After the user select one, dropdown keeps open and request sends with a content update if needed.  Dropdown closes when user click outside area of dropdown or the "x" on the top right corner. |
