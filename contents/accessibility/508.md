  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        Also applies to:<br>
        WCAG 2.0 – Always answer ‘Supports’<br>
        Revised Section 508
        <ul>
          <li>501 (Web)(Software)</li>
          <li>504.2 (Authoring Tool)</li>
      ...
      <td>
        <p>For WCAG 2.0 and the 508 standards, the September 2023 errata update indicates this criterion is always supported. See the <a href="https://www.w3.org/WAI/WCAG20/errata/#editorial" target="_blank">WCAG 2.0 Editorial Errata</a>.
</p>
      </td>
    </tr>
    <tr>
...
<table class="table-compact">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>There is no mechanism or prompt for a user or to verify that they are including helpful alternative content in markdown, therefore, we classify this as partially supports. When including media in markdown, however, there is a prepopulated location where accessible alternative text or description can be added.</p>
      </td>
    </tr>
    <tr>
      <td>
