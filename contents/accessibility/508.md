...
<table class="gl-mb-6 table-compact">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>In most instances a user can move focus away from a focused component using only the keyboard. However, a few instances are known where a user cannot navigate away from focused file editors: <a
