...
<table class="table-compact">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>The product uses descriptive headings and labels to describe the purpose or topic on a page. However, several instances are known where headings could be utilized to better describe the sections of the page: <a
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p>See <a href="#wcag-20-report">WCAG 2.0</a> section for more information on what is not supported.</p>
      </td>
    </tr>
    <tr>
      <td>
