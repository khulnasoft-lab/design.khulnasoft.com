...
GitLab is conformant with the [Voluntary Product Accessibility Template (VPAT®) 2.4](/accessibility/acr) revised in June 2023. This assessment aligns with the **GitLab Enterprise Edition Premium version 16.0**. For GitLab.com, this only includes the SaaS product and not other pages found on the GitLab.com domain.
