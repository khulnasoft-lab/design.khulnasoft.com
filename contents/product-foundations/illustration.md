...
The only exception to this is when using the checkmark icon, if an empty state is a good thing (such as "Congratulations! No dependencies detected."). In that case, an illustration such as this is allowed:

src="/empty-state-checkmark.png"
