...
Only use a placeholder if there isn't enough space for [help text](#help-text). The [search](/product-components/search) component is such an example.
