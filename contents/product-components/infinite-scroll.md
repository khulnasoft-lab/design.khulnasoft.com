...
Infinite scroll is triggered once the user has reached the 20th item of a list and there are more items to load. A [loading spinner](/product-components/spinner) appears at the bottom of the list for the duration of the load time.
