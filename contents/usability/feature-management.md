...
Similar to higher tier features, alpha and beta features should be easily identifiable from the rest of the interface. When a feature can be enabled via a setting, consider adding a badge next to the setting header. Include a link
