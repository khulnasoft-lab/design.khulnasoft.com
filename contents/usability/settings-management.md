...
The Admin Area, groups, subgroups, projects, and individual users have a dedicated area to aggregate their settings together. The [permissions and roles](https://docs.gitlab.com/ee/user/permissions.html) users have dictate what settings they have access to.
