...
| <figure class="figure" role="figure" style="max-width: 280px;" aria-label="Info icon with popover"><img class="figure-img" src="/img/info-popover.png" alt="Info icon with popover" role="img" /><figcaption class="figure-caption">Use the outlined [information-o.svg](http://gitlab-org.gitlab.io/gitlab-svgs/?q=~information-o) with a tooltip or popover</figcaption></figure> | <figure class="figure" role="figure" style="max-width: 280px;" aria-label="Help icon with popover"><img class="figure-img" src="/img/help-popover.png" alt="Help icon with popover" role="img" /><figcaption class="figure-caption">Use the outlined [question-o.svg](http://gitlab-org.gitlab.io/gitlab-svgs/?q=~question-o) without a direct link</figcaption></figure> |
