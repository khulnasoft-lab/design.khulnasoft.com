...
Understand the risk of an AI-powered feature by assessing the _probability_ and _impact_ of an incorrect recommendation. In a high stakes situation, the risk of negative consequences can be high. To mitigate risk in high stakes situations:
...
- Design for potential negative impact. For example, a user should explicitly opt in to a high stakes AI-powered feature.
