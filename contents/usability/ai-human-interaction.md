...
- Clarify limitations and how much the user can trust AI. For example, you can show a detailed disclaimer such as “Content generated by AI should be seen as a starting point and verified before use. It may be incorrect, inappropriate, or diverge from your organization’s standards.” Or, if space is a concern, just “Verify before use.” For more information, see [how to set the right expectations](#set-the-right-expectations).
...
- Show the “GitLab Duo” name at least once per AI-powered feature. The name can be shown _before_ or _after_ user interaction.
...
- The icon is preferably shown _before_ the user interacts with the AI-powered feature. For example, in the button that triggers the action. However, the icon can be shown _after_ user interaction, if more appropriate.
