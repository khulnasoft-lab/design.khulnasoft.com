...
- In the properties panel include '(⚠️ DEPRECATED)' at the start of the 'Description' field. If applicable, include a quick note about what to use instead in the description, and add a link to the new component in the 'Link' field.
