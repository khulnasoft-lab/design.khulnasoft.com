...
<template>
  <div class="md typography">
    ...
    <p>
      ...
      to collaborate on <strong>{{ foundationLabel }}</strong
      >.
    </p>
    ...
    <ul>
      <li>
        <a
          :href="`${$options.gitlabOrgBaseUrl}issues?label_name%5B%5D=foundation%3A${foundationLabel}`"
        >
          Related {{ foundationLabel }} issues
        </a>
      </li>
      <li>
        <a
          :href="`${$options.gitlabOrgBaseUrl}merge_requests?label_name%5B%5D=foundation%3A${foundationLabel}`"
        >
          Related {{ foundationLabel }} merge requests
        </a>
      </li>
      <li>
