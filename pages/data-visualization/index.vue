...
<template>
  <collection
    ...
    description="A data visualization pulls insights from a data set into a narrative, allowing a user to explore data themselves and discover their own insights."
    :items="dataVizList"
  />
</template>
