<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      <h1>Modals</h1>
      <p>Modals are used to reveal critical information, show information without losing context, or when the system needs a user response.</p>
      <h2>Usage</h2>
      ...
      <p><strong>Expanding elements:</strong> Utilize elements such as accordions, <a href="component/tooltips">tooltips</a></li>, or other non-modal patterns to convey your information.</p>
      ...
      <h3>Placement</h3>
      <p>Modals should be <strong>pinned 64px</strong> from the top of the window.</p>
      <h3>Sizes</h3>
