<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <h3>Placement</h3>
      <p>Modals should be <strong>pinned 60px</strong> from the top of the window.</p>
      <h3>Sizes</h3>
      <p>There are 4 sizes for the modals based on our grid structure:</p>
        ...
        <li><strong>Mobile:</strong> Viewport width</li>
      ...
      <ul>
        ...
        <li><strong>Body:</strong> The content in the body should never be ambiguous and unclear. It provides specific information.</li>
          <ul>
            ...
            <li>References to commits, branches, and tags should be monospaced.</li>
          </ul>
        <li><strong>Actions:</strong> Should contain no more than 3 actions and no fewer than 1 and should always be placed within an action bar at the bottom of the modal.</li>
          <ul>
            ...
            <li>There will be some cases where there are no designated primary and secondary actions. In this case, use the secondary button style for all buttons.</li>
            <li>There will be some cases where no actions are designated for the modal. In these cases, an action bar should be used with a dismissive action. There should always be two ways to close/dismiss a modal, and this is important to remember because some modals can be tall and we want to avoid making the user scroll to close a modal.</li>
          </ul>
        </ul>
      <h3>Behavior</h3>
      <p><strong>Autofocus:</strong> The first focusable item should be auto-focused within the modal dialog so that the user can tab in the modal and not become suck behind the overlay. This behavior follows the <a href="https://www.w3.org/TR/wai-aria-practices/examples/dialog-modal/dialog.html">accessibility guidelines</a> for modals.</p>
