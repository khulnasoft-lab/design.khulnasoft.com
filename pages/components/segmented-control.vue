<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <p>Labels for the options need to be as short as possible and should ideally be only one word. Sometimes, that can be done by removing the repeating word in the options and using it as an outside label. For example, instead of having the options “Show whitespace” and “Hide whitespace” use “Whitespace” as a label and only “Show” and “Hide” as options.</p>
      <h3>Sizing</h3>
