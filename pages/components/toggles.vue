<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <p>Avoid using toggles in, for example, <a href="/components/forms">forms</a>, where a submit button, is needed in order to confirm the user's input. This would confuse the user and dilute the expected experience of producing instant results for any toggle throughout the interface.</p>
      <p>Toggles may replace a segmented control, two radio buttons, or a single checkbox to allow users to choose between two opposing states. For help with choosing the right solution, follow the table below.</p>
      <table>
        <thead>
          <tr>
            <th>&nbsp;</th>
