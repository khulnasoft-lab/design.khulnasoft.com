<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <p class="todo">Todo: Add live component block with code example (help text)</p>
      <h3>Icons</h3>
      <p>Icons can be placed inside input fields for various use cases. For example, date picker input fields come with a calendar icon, dropdown input fields come with a downward facing chevron icon. The top right corner is the default position where icons should be placed and the <strong>$grey-700</strong> is the default color.</p>
