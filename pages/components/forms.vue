<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <h4>Clear icon</h4>
      <p>A clear icon can appear in the right corner when the input field isn’t empty to help users clear the content with a single click. Clicking the clear icon removes the content, focuses the input field (if not already), and hides itself. The clear icon isn’t mandatory for general forms, it is recommended for input fields that are expected to change in content often (the <a href="/components/search">Search patterns</a> for example).</p>
      <h3>Text area</h3>
