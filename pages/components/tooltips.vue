<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <p>One exception to this max-width exists on the Groups page. The full namespace in the Groups tree is hidden and shows only the Group name by default. The full namespace is shown in a tooltip on hover. This tooltip contains a max-width of 350px.</p>
      <h2>Layout</h2>
