<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <h2>Usage</h2>
      <p>Radio buttons can never be used alone and must always be used in group form. A vertical layout is preferred, with one choice per line. If you must use a horizontal layout, with multiple options per line, make sure to to space the buttons and labels enough so there is a clear separation between selections.</p>
      <p>Use radio buttons when there is a choice between two or multiple selections, it has a default state, and the user needs a confirmation of it being saved.</p>
