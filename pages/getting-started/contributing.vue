<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="contributing md">
      ...
      <p>If you an interested in contributing to our design system, the first step is ensuring that an issue exists in our <a href="https://gitlab.com/gitlab-org/design.gitlab.com/issues" target="_blank">issue tracker</a>. There are many applications that an issue can have, including:</p>
      <ul>
      ...
      <p>If you were unable to find a related issue in our <a href="https://gitlab.com/gitlab-org/design.gitlab.com/issues" target="_blank">issue tracker</a>, begin by <a href="https://gitlab.com/gitlab-org/design.gitlab.com/issues/new" target="_blank">creating a new one</a>. Creating an issue for each change allows us to easily track all proposals in one place. For changes that affect visual designs or user experiences, it can be helpful to include a mockup.</p>
      <h3>UX proposals</h3>
      ...
      <p>If your proposal involves a change to the frontend implementation, ping a <a href="https://about.gitlab.com/handbook/engineering/projects/#design.gitlab.com" target="_blank">frontend reviewer or maintainer</a> to review and provide feedback.</p>
