  ...
  <div class="content limited">
    <div class="personas md">
      ...
      <div class="persona card">
        <div class="card--header p-t-5 p-r-7 p-b-3 p-l-7">
          <h2>Nazim Ramesh</h2>
        </div>
        <div class="card--content p-t-5 p-r-7 p-b-3 p-l-7">
          <div class="persona__overview">
            <img class="persona__overview--image m-b-6 block" src="~/assets/images/personas/nazim-ramesh.png">
            <table class="persona__overview--demographics">
              <tbody>
                <tr>
      ...
      <div class="persona card">
        ...
        <div class="card--content p-t-5 p-r-7 p-b-3 p-l-7">
          <div class="persona__overview">
            <img class="persona__overview--image m-b-6 block" src="~/assets/images/personas/matthieu-poirier.png">
            <table class="persona__overview--demographics">
              <tbody>
                <tr>
                  <th class="header">Age:</th>
      ...
      <div class="persona card">
        ...
        <div class="card--content p-t-5 p-r-7 p-b-3 p-l-7">
          <div class="persona__overview">
            <img class="persona__overview--image m-b-6 block" src="~/assets/images/personas/james-mackey.png">
            <table class="persona__overview--demographics">
              <tbody>
                <tr>
                  <th class="header">Age:</th>
      ...
      <div class="persona card">
        ...
        <div class="card--content p-t-5 p-r-7 p-b-3 p-l-7">
          <div class="persona__overview">
            <img class="persona__overview--image m-b-6 block" src="~/assets/images/personas/karolina-plaskaty.png">
            <table class="persona__overview--demographics">
              <tbody>
                <tr>
                  <th class="header">Age:</th>
