<template>
  <div class="content limited m-t-7 m-b-7">
    <div class="component md">
      ...
      <p>In general, text is burdensome and adds cognitive load. This load is even more pronounced in a powerful productivity tool such as GitLab. We should not rely on words as a crutch to explain the purpose of a screen. The current navigation and composition of the elements on the screen should get the user 95% there, with the remaining 5% being specific elements such as text.</p> 
      <p>Copy should be concise and short whenever possible. A long message or label is a red flag hinting at a design that needs improvement. For example, use <em>Add</em> instead of <em>Add issue</em> as a button label. Preferably use context and placement of controls to make it obvious what clicking on them will do.</p>
    </div>
  </div>
</template>
